...
namespace CommonLibrary4.Extenssions
{
    public static class DataExtenssions
    {
        ...
        /// <summary>
        /// 获取<see cref="DataTable"/>中的行转换成<see cref="IDictionary{TKey,TValue}"/>对象。
        /// </summary>
        ...
        /// <summary>
        /// 获取<see cref="IDataReader"/>中的行转换成<see cref="IDictionary{TKey,TValue}"/>对象。
        /// </summary>
        /// <typeparam name="TKey">键的类型</typeparam>
        /// <typeparam name="TValue">值的类型</typeparam>
        /// <returns></returns>
