...
namespace CommonLibrary4.Weblog.Collect
{
    public static class CollecterTypeContainer
    {
        ...
        {
            // 加载配置文件中的采集器
            var configuration = CommonLibrary4.Weblog.Configuration.WeblogConfigurationSection.GetSection();
            if (configuration == null)
                return;
            foreach (CommonLibrary4.Weblog.Configuration.CustomCollectElement custom in configuration.Collect.Customs)
            {
