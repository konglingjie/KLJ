...
using CommonLibrary4.Extenssions;

namespace CommonLibrary4.Repository
{
    /// <summary>
    /// 基于数据库的<see cref="IRepository{T}"/>实现
    /// </summary>
    ...
    public class RepositoryDatabase<T> : IRepository<T> where T : class
    {
        ...
        public RepositoryDatabase(CommonLibrary4.Database.DatabaseHelper database)
        {
